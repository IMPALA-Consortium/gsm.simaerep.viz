...
- the github token is in the .env file load GITHUB_PAT as an evironment variable and pass it to the github API
...
- only then update the issue with the summary
